 ...
 */
const SPREAD = 1.3;   // card widths the run reaches before it stops widening
const SOFT = 0.8;     // how quickly it gets there
  ...
  useEffect(() => {
    ...
    const paint = (front) => {
      nodes.forEach((node, index) => {
        ...
        node.firstChild.lastChild.style.opacity = spot.sheen.toFixed(3);
      });
    };
