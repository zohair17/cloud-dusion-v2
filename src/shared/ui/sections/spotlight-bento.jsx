        ...
        return (
          ...
          >
            <Tile
              ...
              className="group relative flex min-h-[clamp(16rem,27vw,21rem)] flex-col justify-end overflow-hidden rounded-[2rem] bg-[#07071e] p-7 pt-16 ring-1 ring-black/[0.06] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-brand-500"
            >
              {item.image ? (
                <Image
                  src={item.image}
              ...
              <div className="relative">
                ...
                */}
                {item.summary ? (
                  <p className="mt-2 line-clamp-3 max-lg:hidden max-w-xl translate-y-1 text-sm leading-relaxed text-white/0 transition-all duration-500 ease-out group-hover:translate-y-0 group-hover:text-white/75 group-focus-within:translate-y-0 group-focus-within:text-white/75">
                    {item.summary}
                  </p>
                ) : null}
